...
export default function Basicos() {
  ...
  const [data, setData] = useState([
    ...
    {id:user.rose,name:'Rosa', descricao:'Desenho mais complexo', url:'https://firebasestorage.googleapis.com/v0/b/drawning-station.appspot.com/o/capas%2FcapaRosa.jpg?alt=media&token=bba4de36-afe5-4e6a-bbd7-9785fa1a3cb2', video:'https://www.youtube.com/watch?v=MhDWTg7vdkI&feature=youtu.be'},
