...
import { BtnRed, InfArea, TextBtn, LapisArea, Lapis, LapisText, BtnCheck, BtnVideo } from './styles'
...
export default function Maca(){
    ...
    const { maca } = useContext(ExerContext);
